...
class TestLockFileParsing:
    ...
    @pytest.mark.asyncio
    async def test_parse_lock_file_pip_compile_format(self, scanner, tmp_path):
...
"""
        ...
        deps = await scanner._parse_lock_file(str(lock_file))
    ...
    @pytest.mark.asyncio
    async def test_parse_lock_file_uv_format(self, scanner, tmp_path):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_find_lock_versions(self, scanner, tmp_path):
...
"""
        ...
        lock_versions = await scanner._find_lock_versions(str(pyproject))

        assert lock_versions["requests"] == "2.31.0"
        assert lock_versions["certifi"] == "2024.2.2"

    @pytest.mark.asyncio
    async def test_find_lock_versions_no_lock_file(self, scanner, tmp_path):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_parse_lock_file_empty(self, scanner, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_parse_lock_file_with_comments_only(self, scanner, tmp_path):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_parse_lock_file_malformed_uv(self, scanner, tmp_path):
