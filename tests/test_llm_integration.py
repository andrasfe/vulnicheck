...
class TestLLMIntegration:
    ...
    async def test_llm_verdict_skips_pattern_matching(self):
        ...
        with patch("vulnicheck.mcp.mcp_passthrough_with_approval.get_risk_assessor") as mock_get_assessor:
            ...
            with patch("vulnicheck.mcp.mcp_passthrough_with_approval.get_dangerous_commands_risk_config") as mock_get_config:
